    ...
    template: `
        <div class="card" dir="rtl">
            ...
            <div class="flex flex-col gap-2 mb-6">
                <div class="text-xl font-semibold text-surface-900 dark:text-surface-0">ملف امني</div>
                <div class="text-surface-600 dark:text-surface-300 text-sm">إدارة الملفات الأمنية (إضافة / تعديل / حذف).</div>
            </div>
            ...
            <p-toolbar styleClass="mb-6">
                <ng-template #start>
                    <p-button label="اضافة ملف امني" icon="pi pi-plus" severity="secondary" (onClick)="openNew()" />
                </ng-template>
                <ng-template #end>
                    <p-iconfield>
            ...
            >
                ...
                <ng-template #body let-row let-rowIndex="rowIndex">
                    <tr>
                        ...
                        <td class="text-surface-700 dark:text-surface-200">
                            <ng-container *ngIf="row.orgNames?.length; else noOrgs">
                                <div class="flex flex-col gap-1">
                                    <span *ngFor="let org of row.orgNames">{{ org.name }}</span>
                                </div>
                            </ng-container>
                            <ng-template #noOrgs>-</ng-template>
                        </td>
                    </tr>
                </ng-template>
                ...
                <ng-template #emptymessage>
                    <tr>
                        <td colspan="4" class="text-center text-surface-600 dark:text-surface-300">لا يوجد ملفات أمنية.</td>
                    </tr>
                </ng-template>
            </p-table>
