    ...
    template: `
        <div class="card" dir="rtl">
            ...
            <div class="flex flex-col gap-2 mb-6">
                <div class="text-xl font-semibold text-surface-900 dark:text-surface-0">موقع الأقلاع</div>
                <div class="text-surface-600 dark:text-surface-300 text-sm">إدارة مواقع الأقلاع (إضافة / تعديل / حذف).</div>
            </div>
            ...
            <p-toolbar styleClass="mb-6">
                <ng-template #start>
                    <p-button label="اضافة موقع الأقلاع" icon="pi pi-plus" severity="secondary" (onClick)="openNew()" />
                </ng-template>
                <ng-template #end>
                    <p-iconfield>
            ...
            >
                ...
                <ng-template #emptymessage>
                    <tr>
                        <td colspan="3" class="text-center text-surface-600 dark:text-surface-300">لا يوجد موقع الأقلاع.</td>
                    </tr>
                </ng-template>
            </p-table>
            ...
            <p-dialog
                ...
                [resizable]="false"
                [style]="{ width: '48rem' }"
                header="نافذة موقع الأقلاع"
            >
                <div class="flex flex-col gap-4" dir="rtl">
                    <div>
                        <label class="block font-medium text-surface-900 dark:text-surface-0 mb-2">موقع الأقلاع</label>
