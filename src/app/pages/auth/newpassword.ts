                ...
                <div class="relative mt-28 max-w-xl mx-auto">
                    ...
                    >
                        <div class="pt-8 pb-8">
                            ...
                            <h1 class="text-4xl lg:text-5xl font-semibold text-surface-950 dark:text-surface-0 text-center">
                                Create a new password</h1>
                        ...
                        <div class="flex items-center justify-center gap-2">
                            <span class="text-surface-500 dark:text-white/64">A problem? <span class="text-primary">Contact support</span> and let us help you.</span>
                        </div>
                    </form>
                </div>
            </div>
